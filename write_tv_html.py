...
st.session_state.session_uuid = "dummy-session-id"

class DummyBundle:
    pass

# We will just write the HTML generated by render_tradingview_widget mock
container_id = "tv_chart_clean_XAUUSD_5"
panel_id = "tv_panel_clean_XAUUSD_5"
symbol = "XAUUSD"
timeframe = "5"
...
with open("d:\\Trading_Bot\\tv_html_output.html", "w", encoding="utf-8") as f:
    f.write(html)

print("Done writing tv_html_output.html")
